...
def fcn(input_size=(500,500,3), num_classes =1000, pre_trained_model=''):
    ...
    conv6 = Conv2D(4096, 1, padding='same', activation='relu', kernel_initializer='he_normal')(conv5)
    conv7 = Conv2D(4096, 1, padding='same', activation='relu', kernel_initializer='he_normal')(conv6)
    conv8 = Conv2D(num_classes, 1, padding='same', activation='relu', kernel_initializer='he_normal')(conv7)
